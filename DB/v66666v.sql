...
drop table if exists cart cascade;                                                                                                    --udalenie tablic
...
CREATE TABLE IF NOT EXISTS places (
    ...
    city varchar(30),
    country varchar(30),
    PRIMARY KEY (place_id, user_id, phone),
    FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE CASCADE
);
...
('earring with big pearl','if you like ocean','charms','https://www.emmahollandjewellery.co.uk/cdn/shop/files/10606LargePearlClipEarrings.jpg?v=1721035197&width=1445',10999.90,15),
...
('yamato','if you want it, you have to take it','knifes','https://www.swordsofnorthshire.com/cdn/shop/files/devil-may-cry-vergil-yamato-replica7.jpg?v=1699472540&width=2400',44444.44,1),
...
('white gold ring','not a default gold','rings','https://www.mauidivers.com/cdn/shop/products/006-07141_500dc4c2-5a87-49c5-8665-696461f2642a.jpg?v=1703719356',27999.90,5),
...
where product_category ='rings';

-----------------------------------------------------------------------------------------------



insert into archive (user_id, product_id, quantity, purchase_date) values
(1, 1, 2, '2025-04-15 10:00:00'),
(1, 2, 1, '2025-04-15 10:00:00')
